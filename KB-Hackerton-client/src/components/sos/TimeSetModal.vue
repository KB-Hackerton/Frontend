...
// Propagate wheel changes back to parent
...
<template>
  <div
    class="fixed bottom-0 left-1/2 -translate-x-1/2 z-10 md:max-w-[365px] flex flex-col items-center h-[28rem] w-full bg-gray-100 rounded-t-[2rem] shadow-[0px_-2px_4px_rgba(0,0,0,0.25)]"
  >
    ...
    <BaseButton @click="emit('close')" class="mt-20"> 확인 </BaseButton>
  </div>
</template>
